...
CLOUD_SEGMENT_VERSION_MAJOR=1
CLOUD_SEGMENT_VERSION_MINOR=0
CLOUD_SEGMENT_VERSION_PATCH=0
CLOUD_SEGMENT_VERSION=${CLOUD_SEGMENT_VERSION_MAJOR}.${CLOUD_SEGMENT_VERSION_MINOR}.${CLOUD_SEGMENT_VERSION_PATCH}
...
mkdir -p build &&
cd build &&
cmake -DCLOUD_SEGMENT_VERSION=${CLOUD_SEGMENT_VERSION} \
