...
BCLOUD_VERSION_MAJOR=1
BCLOUD_VERSION_MINOR=0
BCLOUD_VERSION_PATCH=0
BCLOUD_VERSION=${BCLOUD_VERSION_MAJOR}.${BCLOUD_VERSION_MINOR}.${BCLOUD_VERSION_PATCH}
...
cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=ON\
      -DBCLOUD_VERSION=${BCLOUD_VERSION} \
